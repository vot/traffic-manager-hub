...
module.exports = (req, res) => {
  ...
  return SitesModel.getSiteByKey(newSiteKey, (getSiteErr, getSiteData) => {
    if (getSiteData) {
      return res.render('error', { error: `Site Key "${newSiteKey}" already exists.`, title: errorTitle, returnLink: errorReturnLink });
    }
    ...
    return SitesModel.registerNewSite(newSiteData, (insertErr, insertData) => {
      ...
      console.log(`Site Key "${newSiteData.siteKey}" inserted correctly`);
